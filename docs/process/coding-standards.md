...
配套：[`tdd.md`](./tdd.md)、[`openspec.md`](./openspec.md)、[`../product/editor-plan.md`](../product/editor-plan.md)、[`../editor/architecture.md`](../editor/architecture.md)。Cursor 摘要见 `.cursor/rules/coding-standards.mdc`。
